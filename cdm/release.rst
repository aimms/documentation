...
25.7.4.2 [19-10-2025]
	...
	- Hashes in authorization tokens would be computed differently on Linux and Windows, leading to failed CDM connections when connecting from a Windows client to a server running on Linxu.
