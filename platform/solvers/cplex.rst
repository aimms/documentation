...
-------------------------------------
`IBM ILOG CPLEX <https://www.ibm.com/products/ilog-cplex-optimization-studio/cplex-optimizer>`_ is developed and supported by IBM, Inc. IBM ILOG CPLEX is a registered trademark of IBM, Inc.
