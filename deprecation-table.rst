...
.. csv-table:: 
   ...
   :widths: 10, 10, 10, 10, 20, 20
    ...
    GUI-WinUI, WinUI (all)                    , Deprecated , not before 2026 , Currently only High Prio and fixable issues will be considered for solving and assuming the then current Windows OS still supports third party compenents used                           , WebUI                                                                                                 
