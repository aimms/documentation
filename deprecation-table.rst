...
.. csv-table:: 
   ...
   :widths: 10, 10, 10, 10, 20, 20
    ...
    Algorithmic Capability, AOA (non-GMP), Deprecated, April 2022 , Since Jan 2020 deprecated - no longer available as of 4.85, Start using the `GMP based AOA <https://how-to.aimms.com/Articles/192/192-solve-minlp-with-outer-approximation.html>`__
