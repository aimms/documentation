...
.. csv-table:: 
   ...
   :widths: 10, 10, 10, 10, 20, 20
    ...
    GUI-WebUI, Classic Theme                     , Deprecated , February 2022  , "Deprecated since September 2018 (`4.59.1 <https://documentation.aimms.com/webui/app-misc-settings.html?highlight=theme#use-classic-theme>`_ release).       From 4.84 release onwards, Classic Theme ceases to exist. WebUI will default to AIMMS Theme.", Switch off Classic Theme if still using that. Accordingly adjust Custom CSS if used. More instructions will follow.   
