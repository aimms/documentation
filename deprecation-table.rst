...
.. csv-table:: 
   ...
   :widths: 10, 10, 10, 10, 20, 20
    ...
    GUI-WebUI, Group Widget              , Deprecated ,                 , Start with inability to add and remove suggestion in widget creation dialog    , Switch to `Grid Layout <webui/webui-grid-pages.html>`_ that gives the flexibility to create your desired layout.                                                           
    ...
    GUI-WebUI, `Custom Position <webui/widget-manager.html#custom-position-deprecated>`_ for widgets, Deprecated ,                 , Start with inability to add and remove suggestion in widget creation dialog    , Switch to `Grid Layout <webui/webui-grid-pages.html>`_ that gives the flexibility to create your desired layout.                                                           
