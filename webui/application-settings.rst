...
.. Note::
    ...
    IMPORTANT: When configuring steps for a Workflow, do not use pageIds of Side Panels or Dialog pages in :token:`pageId` or :token:`redirectPageId`. This will result in unwanted behaviour. 
