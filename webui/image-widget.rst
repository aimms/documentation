...
The images themselves should be stored in the *resources*/*images* `sub-folder <folder.html#resouces#images>`_. This folder is not created by default, so you need to create it yourself the very first time that you need it.
