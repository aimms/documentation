...
table widget as shown in the picture below. In this case, choosing FilterTransportData widget as a filter results in a confined pie chart view as only those data points 
