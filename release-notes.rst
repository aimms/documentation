...
-  Now the Table title header cells support custom tooltips using `webui::IdentifierTooltip  <https://documentation.aimms.com/webui/webui/table-widget.html#custom-tooltips-for-identifier-and-indices>`__.
