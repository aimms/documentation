...
* hen reading/writing from/to Excel spreadsheets however, please use the `AIMMSXLLibrary  <https://techblog.aimms.com/2016/06/07/how-to-use-the-aimms-excel-library/>`_  (:token:`axll::`) functions. This way, an Excel does not have to be installed on the server in order to perform these functions.
