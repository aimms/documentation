...
Just like most of the other widgets, the Scalar Widget has a set of "Widget Options":{TOPIC-LINK+widget-options}. At the Miscellaneous tab of the option editor, the following Scalar Widget specific options are available:
